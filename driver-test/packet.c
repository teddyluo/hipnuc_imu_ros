...
/**
 * @brief  Initialization of pose decomposition module
 * @note   complete configuration of a script
 * @param  pkt: pointer of receied package
 * @param  call back function of sucess
 * @code

 *      void OnDataReceived(Packet_t *pkt)
 *      {
 *          pkt->buf: the data buffer;  
            pkt->payload_len:  length of received data in bytes
 *      }
 *
 *      Packet_t pkt;
...
/**
 * @brief  received IMU data
 * @note   called by the serial receiver 
 * @param  c -> serial data
 * @retval CH_OK
 */
